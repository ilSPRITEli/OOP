...
public class Pigeon extends Bird{
    ...
    public Pigeon(double wingSize, double weight, double height){
        ...
        this.setNumberOfPigeon(this.getNumberOfPigeon() + 1);
    }
    ...
    public String toString(){
        return "Pigeon " + this.getWeight() + " kg and " + this.getHeight() + " cm. There are " + this.getNumberOfPigeon() + " pigeons.";
    }
}
